...
class KpmController {
    ...
    _onEventHandler(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let text = "";
            let hasCotentText = event.contentChanges && event.contentChanges.length === 1
                ? true
                : false;
            if (hasCotentText) {
    ...
    updateStaticValues(payload, staticInfo) {
        ...
        if (staticInfo.repoContributorCount &&
    ...
    isTrueEventFile(event, filename) {
        ...
        if (filename === Util_1.getDashboardFile() ||
            (filename &&
    ...
    createKeystrokeCounter(filename, rootPath, nowTimes) {
        ...
        const name = workspaceFolder
            ...
            : Constants_1.UNTITLED_WORKSPACE;
