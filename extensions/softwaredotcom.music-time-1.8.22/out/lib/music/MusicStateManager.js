...
class MusicStateManager {
    ...
    gatherMusicInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!serverIsOnline && !Util_1.isMac) {
                    return;
                }
                const isMacDesktopEnabled = MusicManager_1.MusicManager.getInstance().isMacDesktopEnabled();
                let playingTrack = null;
                if (isMacDesktopEnabled || (!serverIsOnline && Util_1.isMac)) {
    ...
    gatherCodingDataAndSendSongSession(songSession) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const songData = this.buildAggregateData(payloads, initialValue, songSession.start);
