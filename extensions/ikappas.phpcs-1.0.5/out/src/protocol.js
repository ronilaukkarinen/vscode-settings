...
(function (DidStartValidateTextDocumentNotification) {
    DidStartValidateTextDocumentNotification.type = new vscode_languageclient_1.NotificationType("textDocument/didStartValidate");
...
(function (DidEndValidateTextDocumentNotification) {
    DidEndValidateTextDocumentNotification.type = new vscode_languageclient_1.NotificationType("textDocument/didEndValidate");
