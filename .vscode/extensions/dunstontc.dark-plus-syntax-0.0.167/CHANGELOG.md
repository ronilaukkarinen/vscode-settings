...
- Add *Contributing* section to the readme (addresses [Issue [#6](https://github.com/dunstontc/dark-plus-syntax/issues/6)][issue 6])
- Add highlighting for YARD doc comments in Ruby (in response to [YARD Issue [#1217](https://github.com/dunstontc/dark-plus-syntax/issues/1217)][yard 1217])
...
- Roll back change to Diff highlighting from commit [3ec2c04][3ec2c04]. See [Issue [#7](https://github.com/dunstontc/dark-plus-syntax/issues/7)][issue 7]
