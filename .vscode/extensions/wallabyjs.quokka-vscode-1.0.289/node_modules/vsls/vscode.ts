...
export enum ViewItem {
    ...
    // feedback
    SessionFeedbackQuestion = 'feedback.sessionFeedback',
    ReportAProblem = 'feedback.reportAProblem',
    TweetUsYourFeedback = 'feedback.tweetUsYourFeedback',
    Survey = 'feedback.survey',
    GoodFeedback = 'feedback.goodFeedback',
    BadFeedback = 'feedback.badFeedback',
    DontAskAgain = 'feedback.dontAskAgain',
