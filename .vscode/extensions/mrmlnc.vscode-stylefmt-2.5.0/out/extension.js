...
function getSettings() {
    return Object.assign({}, vscode.workspace.getConfiguration('stylefmt'), vscode.workspace.getConfiguration('stylelint'), vscode.workspace.getConfiguration('editor').get('formatOnSave'));
}
