...
module.exports = __webpack_require__(/*! ./promise */ "./node_modules/native-or-bluebird/promise.js")
...
/***/ "./node_modules/native-or-bluebird/promise.js":
/*!****************************************************!*\
  !*** ./node_modules/native-or-bluebird/promise.js ***!
  \****************************************************/
/*! no static exports found */
...
try {
  module.exports = __webpack_require__(/*! bluebird */ "./node_modules/bluebird/js/release/bluebird.js")
} catch (_) {
...
/***/ "./node_modules/promise-exec/index.js":
/*!********************************************!*\
  !*** ./node_modules/promise-exec/index.js ***!
  \********************************************/
/*! no static exports found */
...
var fs = __webpack_require__(/*! mz/fs */ "./node_modules/mz/fs.js");
var EOL = __webpack_require__(/*! os */ "os").EOL;
var thenify = __webpack_require__(/*! thenify */ "./node_modules/thenify/index.js");
var Promise = __webpack_require__(/*! native-or-bluebird */ "./node_modules/native-or-bluebird/index.js");
...
/*
 * @Author: 韩念琪[18112596]
 * @Date: 2019-07-10 09:45:20
 * @Last Modified by: 韩念琪 [18112596]
 * @Last Modified time: 2019-07-10 11:09:00
 */
...
Object.defineProperty(exports, "__esModule", { value: true });
var vscode_1 = __importDefault(__webpack_require__(/*! vscode */ "vscode"));
var promise_exec_1 = __importDefault(__webpack_require__(/*! promise-exec */ "./node_modules/promise-exec/index.js"));
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function () {
        var config, _a, name, email, disposable;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    config = Object.assign({}, vscode_1.default.workspace.getConfiguration('fileheadergit'));
                    console.log('"vscode-fileheader-git" is now active!');
                    return [4 /*yield*/, Promise
                            .all(['name', 'email']
                            .map(function (propKey) { return promise_exec_1.default("git config user." + propKey); }))
                            .then(function (_a) {
                            var name = _a[0][0], email = _a[1][0];
                            return [name.trim(), email.trim()];
                        })];
                case 1:
                    _a = _b.sent(), name = _a[0], email = _a[1];
                    config.Author = name;
                    config.Email = email;
                    config.LastModifiedBy = name;
                    disposable = vscode_1.default.commands.registerCommand('extension.fileheadergit', function () {
                        return __awaiter(this, void 0, void 0, function () {
                            var editor, line;
                            return __generator(this, function (_a) {
                                editor = vscode_1.default.editor || vscode_1.default.window.activeTextEditor;
                                ...
                                editor.edit(function (editBuilder) {
                                    return __awaiter(this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_a) {
                                            ...
                                            try {
                                                tpl = new template(config.tpl).render(data);
                                                editBuilder.insert(new vscode_1.default.Position(line, 0), tpl);
                                            }
                                            catch (error) {
                                                console.error(error);
                                            }
                    ...
                    vscode_1.default.workspace.onDidSaveTextDocument(function (file) {
                        setTimeout(function () {
                            return __awaiter(this, void 0, void 0, function () {
                                var f, editor, document, isReturn, authorRange, authorText, lastTimeRange, lastTimeText, diff, lineCount, comment, i, linetAt, line, range, time, oldTime, curTime, diff;
                                return __generator(this, function (_a) {
                                        ...
                                        for (i = 0; i < lineCount; i++) {
                                            ...
                                            if (line.startsWith("/*") && !line.endsWith("*/")) { //是否以 /* 开头
                                                ...
                                                if (line.indexOf('@Last\ Modified\ by') > -1) { //表示是修改人
                                                    ...
                                                    time = line.replace('@Last\ Modified\ time:', '').replace('*', '');
                                                    oldTime = new Date(time).getTime();
                                                    curTime = new Date();
                                                    diff = (curTime.getTime() - oldTime) / 1000;
                                                    lastTimeRange = range;
...
function getConfiguration() {
    return vscode_1.default.workspace.getConfiguration('mocha');
}
function getLineText(lineNum, editor) {
    ...
    var start = new vscode_1.default.Position(lineNum, 0);
    var lastLine = document.lineAt(lineNum);
    var end = new vscode_1.default.Position(lineNum, lastLine.text.length);
    var range = new vscode_1.default.Range(start, end);
...
function template(tpl) {
    var fn, match, code = ['var r=[];\nvar _html = function (str) { return str.replace(/&/g, \'&amp;\').replace(/"/g, \'&quot;\').replace(/\'/g, \'&#39;\').replace(/</g, \'&lt;\').replace(/>/g, \'&gt;\'); };'], re = /\{\s*([a-zA-Z\.\_0-9()]+)(\s*\|\s*safe)?\s*\}/m, addLine = function (text) {
