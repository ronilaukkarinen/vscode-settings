...
class PhpcsServer {
    ...
    sendStartValidationNotification(document) {
        ...
        this.connection.sendNotification(proto.DidStartValidateTextDocumentNotification.type, {
            textDocument: vscode_languageserver_1.TextDocumentIdentifier.create(document.uri),
    ...
    sendEndValidationNotification(document) {
        ...
        this.connection.sendNotification(proto.DidEndValidateTextDocumentNotification.type, {
            textDocument: vscode_languageserver_1.TextDocumentIdentifier.create(document.uri),
            buffered: this.queue.size
        });
    ...
    validateSingle(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (settings.lintOnlyOpened) {
                ...
                if (!isOpened) {
                    this.connection.tracer.log(strings.format(strings_1.StringResources.IgnoredClosedTextDocument, uri));
                    return;
                }
            }
            ...
            if (this.validating.has(uri) === false) {
                ...
                const inQueue = this.queue.has(uri);
                if (inQueue) {
