...
class ProviderItemManager {
    ...
    getNoMusicTimeConnectionButton() {
        return this.buildActionItem("offline", "offline", null, cody_music_1.PlayerType.NotAssigned, "Music Time Offline", "Unable to connect to Music Time");
    }
    getActiveSpotifyDevicesButton() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const webPlayerDevice = devices.find((d) => d.type.toLowerCase() === "computer" &&
                d.name.toLowerCase().includes("web player"));
            const desktopDevice = devices.find((d) => d.type.toLowerCase() === "computer");
            let msg = "";
    ...
    getSpotifyPremiumAccountRequiredButton() {
        return this.buildActionItem("spotifypremium", "action", "musictime.connectSpotify", cody_music_1.PlayerType.NotAssigned, "Spotify Premium Required", "Connect to your premium Spotify account to use the play, pause, next, and previous controls");
    }
    ...
    getLoadingButton() {
        return this.buildActionItem("loading", "action", null, cody_music_1.PlayerType.NotAssigned, "Loading...", "please wait", null, "audio.svg");
    }
    getConnectToSpotifyButton() {
        return this.buildActionItem("connectspotify", "spotify", "musictime.connectSpotify", cody_music_1.PlayerType.WebSpotify, "Connect Spotify", "Connect Spotify to view your playlists");
    }
    getRecommendationConnectToSpotifyButton() {
        // Connect Spotify to see recommendations
        return this.buildActionItem("connectspotify", "spotify", "musictime.connectSpotify", cody_music_1.PlayerType.WebSpotify, "Connect Spotify to see recommendations", "Connect Spotify to see your playlist and track recommendations");
    }
