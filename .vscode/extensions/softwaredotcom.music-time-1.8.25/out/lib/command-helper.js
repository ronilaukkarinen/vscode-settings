...
function createCommands() {
    ...
    // CONNECT SPOTIFY CMD
    cmds.push(vscode_1.commands.registerCommand("musictime.connectSpotify", () => {
        MusicControlManager_1.connectSpotify();
    }));
    const slackConnectCommand = vscode_1.commands.registerCommand("musictime.connectSlack", () => {
        SlackControlManager_1.connectSlack();
    });
    cmds.push(slackConnectCommand);
    const disconnectSpotifyCommand = vscode_1.commands.registerCommand("musictime.disconnectSpotify", () => {
        MusicControlManager_1.disconnectSpotify();
    });
    cmds.push(disconnectSpotifyCommand);
    const disconnectSlackCommand = vscode_1.commands.registerCommand("musictime.disconnectSlack", () => {
        MusicControlManager_1.disconnectSlack();
    });
    cmds.push(disconnectSlackCommand);
    // this should only be attached to the refresh button
    const reconcilePlaylistCommand = vscode_1.commands.registerCommand("musictime.refreshButton", () => __awaiter(this, void 0, void 0, function* () {
    ...
    // this should only be attached to the refresh button
    const hardRefreshPlaylistCommand = vscode_1.commands.registerCommand("musictime.hardRefreshPlaylist", () => __awaiter(this, void 0, void 0, function* () {
    ...
    const refreshRecommendationsCommand = vscode_1.commands.registerCommand("musictime.refreshRecommendations", () => __awaiter(this, void 0, void 0, function* () {
        setTimeout(() => {
