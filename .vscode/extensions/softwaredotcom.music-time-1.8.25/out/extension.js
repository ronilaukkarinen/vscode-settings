...
function intializePlugin(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        offline_song_data_interval = setInterval(() => {
            MusicStateManager_1.MusicStateManager.getInstance().processOfflineSongSessions();
        }, ten_min_ms);
        ...
        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            yield MusicStateManager_1.MusicStateManager.getInstance().processOfflineSongSessions();
        }), 1000 * 3);
        // 5 second interval to check music info
        const gatherMusicInterval = Util_1.isMac() ? 1000 * 5 : 1000 * 6;
