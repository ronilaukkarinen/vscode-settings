...
class KpmProviderManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!loggedIn) {
                ...
                if (connectedToInfo) {
                    ...
                    const connectedToButton = this.getActionButton(connectedToInfo.label, connectedToInfo.tooltip, cmd, connectedToInfo.icon);
    ...
    getSwitchAccountsButton() {
        ...
        const item = this.getActionButton("Switch accounts", tooltip, "codetime.switchAccounts", "paw.svg", "TreeViewSwitchAccounts");
        return item;
    }
