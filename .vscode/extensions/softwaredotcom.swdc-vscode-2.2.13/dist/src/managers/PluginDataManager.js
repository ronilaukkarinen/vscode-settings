...
class PluginDataManager {
    ...
    */
    editorFocusHandler() {
        ...
        const diff = Math.max(nowTimes.now_in_sec - this.stats.last_unfocused_timestamp_utc, 0);
    ...
    */
    editorUnFocusHandler() {
        ...
        const diff = Math.max(nowTimes.now_in_sec - this.stats.last_focused_timestamp_utc, 0);
        if (diff <= FIFTEEN_MIN_IN_SECONDS) {
            this.stats.elapsed_code_time_seconds += diff;
        }
        // Step 3) Clear "last_focused_timestamp_utc"
    ...
    */
    processPayloadHandler(payload, sendNow) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.stats.elapsed_seconds = Math.max(nowTimes.now_in_sec - this.stats.last_payload_end_utc, 60);
            ...
            payload.elapsed_code_time_seconds = Math.max(this.stats.elapsed_code_time_seconds, this.stats.elapsed_active_code_time_seconds);
