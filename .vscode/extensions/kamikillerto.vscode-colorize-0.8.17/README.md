...
By default colorize read and parse all files, in your workspace, that are targeted by the settings [colorize.languages](https://github.com/kamikillerto/vscode-colorize/blob/master/colorizelanguages), [colorize.include](#colorizeinclude), [colorize.exlude](#colorizeexclude)
