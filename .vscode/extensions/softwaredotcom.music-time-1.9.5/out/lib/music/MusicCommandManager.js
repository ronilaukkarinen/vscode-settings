...
class MusicCommandManager {
    ...
    static syncControls(track, showLoading = false, statusOverride = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { requiresAccess, foundDevice } = yield this.getSpotifyState();
    ...
    static showLaunchPlayerControls() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { requiresAccess, showPremiumRequired, } = yield this.getSpotifyState();
            const requiresReAuth = MusicUtil_1.requiresSpotifyReAuthentication();
            const action = requiresReAuth ? "Reconnect" : "Connect";
    ...
    static getSpotifyState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requiresAccess = requiresReAuth || needsSpotifyAccess ? true : false;
