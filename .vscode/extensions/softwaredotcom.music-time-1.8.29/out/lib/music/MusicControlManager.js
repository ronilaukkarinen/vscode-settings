...
class MusicControlManager {
    constructor() {
        this.musicStateMgr = MusicStateManager_1.MusicStateManager.getInstance();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (hasSpotifyPlaybackAccess) {
                if (this.isLikedSongPlaylist()) {
                    ...
                    const playerName = MusicManager_1.MusicManager.getInstance().getPlayerNameForPlayback();
                    yield this.musicCmdUtil.runSpotifyCommand(cody_music_1.previous, [
                        playerName,
                    ]);
                }
            }
    ...
    playSpotifyWebPlaylistTrack(isTrack, devices) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isLikedSongsPlaylist) {
                ...
                yield this.playSpotifyByTrackAndPlaylist(playlistId, selectedTrack.id, devices);
            }
            else {
                // play the playlist
                yield this.playSpotifyByTrackAndPlaylist(playlistId, "", devices);
            }
            setTimeout(() => {
                if (trackRepeating) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isLikedSongsPlaylist) {
                ...
                if (!isWin) {
                    ...
                    this.playSpotifyByTrackAndPlaylist(selectedPlaylist.id, selectedTrack.id, devices);
                }
            }
            setTimeout(() => {
                if (trackRepeating) {
    ...
    playSpotifyByTrackAndPlaylist(playlistId, trackId, devices = []) {
        return __awaiter(this, void 0, void 0, function* () {
