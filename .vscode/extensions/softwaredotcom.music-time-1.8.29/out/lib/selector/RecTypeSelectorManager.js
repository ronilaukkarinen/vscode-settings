...
exports.showGenreSelections = showGenreSelections;
function showCategorySelections() {
    return __awaiter(this, void 0, void 0, function* () {
        let menuOptions = {
            items: [],
...
exports.showCategorySelections = showCategorySelections;
function getCategorySelections() {
    ...
    const items = [
        ...
        {
            label: "Happy",
            description: "Positive, uplifting, mood-boosting; good for any type of coding",
            args: ["Happy", 5, [], { min_valence: 0.7, target_valence: 1 }],
        },
        // high energy
        {
            label: "Energetic",
            description: "Dynamic, loud, stimulating; grab a coffee and let's go",
            args: ["Energetic", 5, [], { min_energy: 0.7, target_energy: 1 }],
        },
        // high danceability
        {
            label: "Danceable",
            description: "Songs with a stable beat and rhythm; good for fast-paced work",
            args: [
                "Danceable",
                5,
                [],
        ...
        {
            label: "Familiar",
            description: "Similar to your Liked Songs, familiar songs helps you get into flow faster",
            args: ["Familiar", 5],
        },
        // Low loudness
        {
            label: "Quiet music",
            description: "Songs that are soft and low energy, helping you stay focused",
            args: [
                "Quiet music",
                5,
                [],
...
//# sourceMappingURL=RecTypeSelectorManager.js.map