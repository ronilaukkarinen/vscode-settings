...
function showPlaylistOptionsMenu() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const items = getOptionItems(isShuffling, isRepeatingPlaylist, isRepeatingTrack, isPlaying);
        let menuOptions = {
            items,
            placeholder: msg,
        };
...
function getOptionItems(isShuffling, isRepeatingPlaylist, isRepeatingTrack, isPlaying) {
    return __awaiter(this, void 0, void 0, function* () {
        const items = [];
        if (isShuffling) {
            items.push({
