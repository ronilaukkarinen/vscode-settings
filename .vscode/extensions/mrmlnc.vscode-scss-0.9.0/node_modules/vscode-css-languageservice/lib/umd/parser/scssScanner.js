...
(function (factory) {
    ...
    exports.Forward = customTokenValue++;
    exports.Use = customTokenValue++;
            ...
            if (this.stream.advanceIfChar(_ATS)) {
                ...
                if (this.ident(content)) {
                    ...
                    if (keywordText === '@forward') {
                        return this.finishToken(offset, exports.Forward, keywordText);
                    }
                    else if (keywordText === '@use') {
                        return this.finishToken(offset, exports.Use, keywordText);
                    }
                }
                this.stream.goBackTo(offset);
            }
