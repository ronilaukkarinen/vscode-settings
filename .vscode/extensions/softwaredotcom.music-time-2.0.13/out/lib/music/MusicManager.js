...
const MusicRecommendationManager_1 = require("./MusicRecommendationManager");
...
class MusicManager {
    constructor() {
        this.playMusicSelection = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const useSpotifyWeb = isPremiumUser || !Util_1.isMac() ? true : false;
            if (isRecommendationTrack || isLikedSong) {
                let result = null;
                if (useSpotifyWeb) {
                    // it's a liked song or recommendation track play request
                    result = yield this.playRecommendationsOrLikedSongsByPlaylist(this.dataMgr.selectedTrackItem, deviceId);
                }
                else {
                    ...
                    result = yield cody_music_1.playTrackInContext(cody_music_1.PlayerName.SpotifyDesktop, params);
                }
                yield musicCommandUtil.checkIfAccessExpired(result);
            }
            else if (playlistId) {
                if (useSpotifyWeb) {
    ...
    refreshPlaylists() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.dataMgr.currentPlayerName === cody_music_1.PlayerName.ItunesDesktop) {
                yield this.refreshPlaylistForPlayer();
            }
            else {
                yield this.refreshPlaylistForPlayer();
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (playerName === cody_music_1.PlayerName.ItunesDesktop) {
                ...
                if (CONNECTED || hasPlaylists) {
                    ...
                    const hasTracksForRecs = this.dataMgr.trackIdsForRecommendations &&
                        this.dataMgr.trackIdsForRecommendations.length
                        ? true
                        : false;
                    if (!hasTracksForRecs) {
                        yield MusicUtil_1.buildTracksForRecommendations(playlists);
    ...
    initializeSlack() {
        return __awaiter(this, void 0, void 0, function* () {
            const slackOauth = yield DataController_1.getSlackOauth();
            if (slackOauth) {
    ...
    updateSpotifyAccessInfo(spotifyOauth) {
        return __awaiter(this, void 0, void 0, function* () {
            if (spotifyOauth && spotifyOauth.access_token) {
                ...
                Util_1.setItem("requiresSpotifyReAuth", true);
                // update cody config
                this.dataMgr.updateCodyConfig();
    ...
    initializeSpotify() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (MusicUtil_1.requiresSpotifyAccess()) {
                yield DataController_1.getMusicTimeUserStatus();
            }
            else {
                // this should only be done after we've updated the cody config
                const requiresReAuth = yield this.requiresReAuthentication();
                if (requiresReAuth) {
                    ...
                    setTimeout(() => {
                        ...
                        DataController_1.populateSpotifyDevices();
                    }, 2000);
                }
            }
    ...
    requiresReAuthentication() {
        return __awaiter(this, void 0, void 0, function* () {
            const checkedSpotifyAccess = Util_1.getItem("vscode_checkedSpotifyAccess");
            const hasAccessToken = Util_1.getItem("spotify_access_token");
            if (!checkedSpotifyAccess && hasAccessToken) {
                const expired = yield cody_music_1.accessExpired();
                if (expired) {
                    Util_1.setItem("requiresSpotifyReAuth", true);
                }
                Util_1.setItem("vscode_checkedSpotifyAccess", true);
                return expired;
            }
            return false;
        });
    ...
    launchTrackPlayer(playerName = null, callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isPremiumUser = MusicManager.getInstance().isSpotifyPremium();
            const isMacUser = Util_1.isMac();
            const hasDesktopDevice = activeDesktopPlayerDevice || desktop ? true : false;
            const requiresDesktopLaunch = !isPremiumUser && Util_1.isMac() && !hasDesktopDevice ? true : false;
            ...
            const hasSelectedTrackItem = this.dataMgr.selectedTrackItem && this.dataMgr.selectedTrackItem.id
                ? true
                : false;
            const hasSelectedPlaylistItem = this.dataMgr.selectedPlaylist && this.dataMgr.selectedPlaylist.id
                ? true
                : false;
            if (!isPremiumUser &&
    ...
    checkDeviceLaunch(playerName, tries = 5, callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                yield DataController_1.populateSpotifyDevices(true);
    ...
    isMacDesktopEnabled() {
        const { webPlayer, desktop, activeDevice, activeComputerDevice, activeWebPlayerDevice, activeDesktopPlayerDevice, } = MusicUtil_1.getDeviceSet();
        return Util_1.isMac() && (desktop || activeDesktopPlayerDevice) ? true : false;
    }
    hasSpotifyUser() {
    ...
    showPlayerLaunchConfirmation(callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isPremiumUser = MusicManager.getInstance().isSpotifyPremium();
            if (Util_1.isMac() && !isPremiumUser) {
                return this.launchTrackPlayer(cody_music_1.PlayerName.SpotifyDesktop, callback);
            }
            else {
    ...
    playInitialization(callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hasDesktopOrWebLaunched = hasDesktopLaunched || webPlayer || activeWebPlayerDevice
                ? true
                : false;
            const isPremiumUser = MusicManager.getInstance().isSpotifyPremium();
            const requiresDesktopLaunch = !isPremiumUser && Util_1.isMac() && !hasDesktopLaunched ? true : false;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (foundPlaylist) {
                ...
                if (foundPlaylist.id === Constants_1.SPOTIFY_LIKED_SONGS_PLAYLIST_NAME) {
                    ...
                    if (errMsg) {
                        vscode_1.window.showInformationMessage(`Error removing the selected track. ${errMsg}`);
                    }
                    else {
