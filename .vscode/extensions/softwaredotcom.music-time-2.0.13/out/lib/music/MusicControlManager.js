...
const musicCmdUtil = MusicCommandUtil_1.MusicCommandUtil.getInstance();
const stateMgr = MusicStateManager_1.MusicStateManager.getInstance();
...
class MusicControlManager {
    ...
    nextSong() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isLikedSongPlaylist()) {
                ...
                yield musicCmdUtil.runSpotifyCommand(cody_music_1.next, [cody_music_1.PlayerName.SpotifyWeb]);
            }
            setTimeout(() => {
    ...
    previousSong() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.isLikedSongPlaylist()) {
                ...
                yield musicCmdUtil.runSpotifyCommand(cody_music_1.previous, [
    ...
    playSong(tries = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!deviceId && tries === 1) {
                ...
                yield MusicManager_1.MusicManager.getInstance().playInitialization(controlMgr.playSong);
            }
            else {
                if (!dataMgr.runningTrack || !dataMgr.runningTrack.id) {
                    dataMgr.runningTrack = yield cody_music_1.getTrack(cody_music_1.PlayerName.SpotifyWeb);
                    if (!dataMgr.runningTrack || !dataMgr.runningTrack.id) {
                        yield stateMgr.updateRunningTrackToMostRecentlyPlayed();
                        const result = yield MusicCommandUtil_1.MusicCommandUtil.getInstance().runSpotifyCommand(cody_music_1.play, [
                            cody_music_1.PlayerName.SpotifyWeb,
                            {
                                ...
                                device_id: MusicUtil_1.getDeviceId(),
                                offset: 0,
                            },
                        ]);
                        setTimeout(() => {
                    ...
                    if (controlMgr.useSpotifyDesktop()) {
                        ...
                        result = yield musicCmdUtil.runSpotifyCommand(cody_music_1.play, [
                            cody_music_1.PlayerName.SpotifyWeb,
                        ]);
                    }
    ...
    pauseSong() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.useSpotifyDesktop()) {
                ...
                result = yield musicCmdUtil.runSpotifyCommand(cody_music_1.pause, [
                    cody_music_1.PlayerName.SpotifyWeb,
                ]);
            }
            if (result && (result.status < 300 || result === "ok")) {
    ...
    setMuteOn() {
        return __awaiter(this, void 0, void 0, function* () {
            yield musicCmdUtil.runSpotifyCommand(cody_music_1.mute, [cody_music_1.PlayerName.SpotifyWeb]);
        });
    }
    setMuteOff() {
        return __awaiter(this, void 0, void 0, function* () {
            yield musicCmdUtil.runSpotifyCommand(cody_music_1.unmute, [cody_music_1.PlayerName.SpotifyWeb]);
        });
    }
    useSpotifyDesktop() {
    ...
    playSpotifyDesktopPlaylistTrack(devices) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // get the selected playlist
            const selectedPlaylist = dataMgr.selectedPlaylist;
            const isPrem = MusicManager_1.MusicManager.getInstance().isSpotifyPremium();
    ...
    addToPlaylistMenu(playlistItem) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let playlists = MusicManager_1.MusicManager.getInstance()
                .currentPlaylists;
                ...
                if (matchingPlaylists.length) {
                    ...
                    if (matchingPlaylist) {
                        ...
                        const trackUri = playlistItem.uri ||
                            Util_1.createUriFromTrackId(playlistItem.id);
...
function disconnectOauth(type, confirmDisconnect = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (selection === Constants_1.YES_LABEL) {
            ...
            yield HttpClient_1.softwarePut(`/auth/${type_lc}/disconnect`, {}, Util_1.getItem("jwt"));
