...
class KpmProviderManager {
    ...
    getSwitchAccountsButton() {
        ...
        const item = this.getActionButton("Switch account", tooltip, "codetime.switchAccounts", "paw.svg", "TreeViewSwitchAccounts");
        item.location = "ct_menu_tree";
    ...
    getActionButton(label, tooltip, command, icon = null, eventDescription = "", color = "blue") {
        const item = new models_1.KpmItem();
    ...
    getSessionSummaryItems(data) {
        ...
        values = [];
        const currLinesAdded = this._currentKeystrokeStats.currentDayLinesAdded + data.currentDayLinesAdded;
        ...
        values = [];
        const currLinesRemoved = this._currentKeystrokeStats.currentDayLinesRemoved + data.currentDayLinesRemoved;
        ...
        values = [];
        const currKeystrokes = this._currentKeystrokeStats.currentDayKeystrokes + data.currentDayKeystrokes;
