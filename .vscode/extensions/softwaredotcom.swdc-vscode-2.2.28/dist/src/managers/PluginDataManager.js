...
class PluginDataManager {
    ...
    /**
      ...
      */
    processPayloadHandler(payload, sendNow, nowTimes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { sessionMinutes } = SessionSummaryData_1.getTimeBetweenLastPayload();
            ...
            Util_1.setItem("latestPayloadTimestampEndUtc", now);
