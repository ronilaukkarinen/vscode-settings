...
class MusicManager {
    constructor() {
        this.playMusicSelection = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const isLikedSong = this.dataMgr.selectedPlaylist &&
                this.dataMgr.selectedPlaylist.name === Constants_1.SPOTIFY_LIKED_SONGS_PLAYLIST_NAME
                ? true
                : false;
    ...
    refreshPlaylistForPlayer(serverIsOnline) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let hasLikedSongs = this.dataMgr.spotifyLikedSongs && this.dataMgr.spotifyLikedSongs.length
                ? true
                : false;
            // fetch the playlists
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (nextTrack) {
                ...
                if (hasSpotifyPlaybackAccess) {
                    // play the next track
                    yield MusicCommandUtil_1.MusicCommandUtil.getInstance().runSpotifyCommand(cody_music_1.playSpotifyTrack, [
                        playlistItem.id,
                        deviceId,
                    ]);
                }
    ...
    hasSpotifyPlaybackAccess() {
        return this.dataMgr.spotifyUser && this.dataMgr.spotifyUser.product === "premium"
            ? true
            : false;
    }
    hasSpotifyUser() {
    ...
    isSpotifyPremium() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.hasSpotifyUser() && this.dataMgr.spotifyUser.product === "premium"
                ? true
                : false;
        });
    }
    ...
    playInitialization(callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (no_devices ||
                (!deviceSet.webPlayer && !deviceSet.desktop && !deviceSet.activeDevice)) {
